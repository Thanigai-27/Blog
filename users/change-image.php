...
$query=mysqli_query($con,"update posts set image='$imgnewfile' where id='$postid'");
if($query)
{
...
?>
                                        ...
                                        <li>
                                           ...
                                           <li>
                                            <a href="edit-post.php?pid=<?php echo htmlentities($postid);?>"> Edit Post </a>
                                        </li>
                                        <li class="active">
                                           Update Image
                                        </li>
...
<?php
$postid=intval($_GET['pid']);
$query=mysqli_query($con,"select image from posts where id='$postid' and active=1 ");
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Current Feature Image</b></h4>
