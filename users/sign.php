                                ...
                                <div class="text-center account-logo-box" style = "background: #6610f2;">
                                    <h2 class="text-uppercase">
                                        <a href="../index.php" class="text-success">
                                            <span><p style = "color:white">BLOG</p></span>
                                        </a>
                                    </h2>
                                    <!--<h4 class="text-uppercase font-bold m-b-0">Sign In</h4>-->
                                </div>
                                <div class="account-content">
                                    <form class="form-horizontal" method="post" action="sign.php">

                                      
                                        <div class="form-group ">
                                            <div class="col-xs-12">
                                                <input class="form-control" type="text" required="" name="name" placeholder="Name" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <div class="col-xs-12">
                                         ...
                                         <div class="form-group ">
                                          ...
                                          <div class="form-group ">
                                            <div class="col-xs-12">
                                                <input class="form-control" type="text" required="" name="contact" placeholder="Contact number" autocomplete="off">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group account-btn text-center m-t-10">
                                            <div class="col-xs-12">
                                                <button class="btn w-md btn-bordered btn-danger waves-effect waves-light" type="submit" name="sign">Register</button>
