...
$active=1;
$sql = "SELECT * FROM posts WHERE published=0 and active=1 ORDER BY published_date DESC LIMIT $offset, $no_of_records_per_page";
...
<td><a href="view-post.php?pid=<?php echo htmlentities($row['id']);?>"><p class="fa fa-eye" style="color: #29b6f6;">View</p></a> 
 </td>
 </tr>
<?php } }?>
