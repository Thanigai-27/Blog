...
$total_pages_sql = "SELECT COUNT(*) FROM comments where status=0";
...
$sql = "SELECT * FROM comments WHERE status=0 LIMIT $offset, $no_of_records_per_page";
...
<td><a href="view-comment.php?id=<?php echo htmlentities($row['id']);?>"><p class="fa fa-eye" style="color: #29b6f6;">View</p></a> 
 </td>
