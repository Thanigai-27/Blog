...
if(isset($_POST['publish']))
{
    ...
    $query=mysqli_query($con,"UPDATE posts set published=0 WHERE id=$postid");
							...
							<div class="col-xs-12">
								<div class="page-title-box">
                                    ...
                                    <ol class="breadcrumb p-0 m-0">
                                        ...
                                        <li>
                                            <a href="published-posts.php"> Posts </a>
                                        </li>
                                        <li class="active">
                                            View Post
                                        </li>
...
<img src="../users/postimages/<?php echo htmlentities($row['image']);?>"" width="400" height="350"/>
<br />
</div>
</div>
</div>
...
<button type="submit" name="publish" >UNPUBLISH</button>
</div>
